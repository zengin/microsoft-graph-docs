---
title: "Update educationalActivities"
description: "Update the properties of an educationalActivities object."
...
# Update educationalActivities
Namespace: microsoft.graph

Update the properties of an educationalActivities object.
...
-->
``` http
PATCH /users/{usersId}/profile/educationalActivities
```
...
<!-- {
  "blockType": "request",
  "name": "update_educationalactivities"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/profile/educationalActivities
...
{
  "@odata.type": "#microsoft.graph.educationalActivity",
  "id": "8c5951a5-51a5-8c59-a551-598ca551598c",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData"
  },
