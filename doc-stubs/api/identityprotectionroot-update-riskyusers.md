---
title: "Update riskyUsers"
description: "Update the properties of a riskyUsers object."
...
Update the properties of a riskyUsers object.
...
-->
``` http
PATCH /identityProtection/riskyUsers
```
...
<!-- {
  "blockType": "request",
  "name": "update_riskyusers"
}
-->
``` http
PATCH https://graph.microsoft.com/v1.0/identityProtection/riskyUsers
