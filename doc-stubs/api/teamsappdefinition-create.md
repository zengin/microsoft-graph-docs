...
-->
``` http
POST /me/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions
POST /users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions
```
...
-->
``` http
POST https://graph.microsoft.com/beta/me/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions
