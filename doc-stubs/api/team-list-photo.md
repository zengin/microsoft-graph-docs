...
-->
``` http
GET ** Collection URI for microsoft.graph.profilePhoto not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.profilePhoto not found
```
  ...
  "value": [
    {
      ...
      "id": "93d0b6c7-b6c7-93d0-c7b6-d093c7b6d093"
    }
  ]
}
```
