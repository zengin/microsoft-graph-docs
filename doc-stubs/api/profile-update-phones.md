---
title: "Update phones"
description: "Update the properties of a phones object."
...
Update the properties of a phones object.
...
-->
``` http
PATCH /users/{usersId}/profile/phones
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/profile/phones
