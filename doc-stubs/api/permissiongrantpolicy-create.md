...
-->
``` http
POST ** Collection URI for microsoft.graph.permissionGrantPolicy not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.permissionGrantPolicy not found
...
{
  "@odata.type": "#microsoft.graph.permissionGrantPolicy",
  "id": "85394400-4400-8539-0044-398500443985",
  "deletedDateTime": "String (timestamp)",
  "description": "String",
  "displayName": "String"
}
