...
-->
``` http
GET /me/teamwork/installedApps/{teamsAppInstallationId}/teamsAppDefinition
GET /users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsAppDefinition
GET /me/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions/{teamsAppDefinitionId}
...
-->
``` http
GET https://graph.microsoft.com/beta/me/teamwork/installedApps/{teamsAppInstallationId}/teamsAppDefinition
```
