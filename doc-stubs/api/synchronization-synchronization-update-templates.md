...
-->
``` http
PATCH /servicePrincipals/{servicePrincipalsId}/synchronization/templates
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/servicePrincipals/{servicePrincipalsId}/synchronization/templates
