...
description: "Update the properties of an appointments object."
...
Update the properties of an appointments object.
...
-->
``` http
PATCH /bookingBusinesses/{bookingBusinessesId}/appointments
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/bookingBusinesses/{bookingBusinessesId}/appointments
