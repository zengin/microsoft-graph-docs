...
description: "Update the properties of a customers object."
...
-->
``` http
PATCH /bookingBusinesses/{bookingBusinessesId}/customers
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/bookingBusinesses/{bookingBusinessesId}/customers
