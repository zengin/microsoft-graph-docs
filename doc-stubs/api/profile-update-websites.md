...
description: "Update the properties of a websites object."
...
Update the properties of a websites object.
...
-->
``` http
PATCH /users/{usersId}/profile/websites
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/profile/websites
