...
-->
``` http
DELETE /policies/conditionalAccessPolicies/{id}
```
...
<!-- {
  "blockType": "request",
  "name": "delete_conditionalaccesspolicies_from_policyroot"
}
-->
``` http
DELETE https://graph.microsoft.com/v1.0/policies/conditionalAccessPolicies/{id}
```
