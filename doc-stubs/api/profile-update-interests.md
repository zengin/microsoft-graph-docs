...
description: "Update the properties of an interests object."
...
Update the properties of an interests object.
...
-->
``` http
PATCH /users/{usersId}/profile/interests
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/profile/interests
...
{
  "@odata.type": "#microsoft.graph.personInterest",
  "id": "1f1e8697-8697-1f1e-9786-1e1f97861e1f",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData"
  },
