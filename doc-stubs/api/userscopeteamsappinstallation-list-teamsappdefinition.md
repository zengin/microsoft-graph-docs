...
-->
``` http
GET /me/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions
...
-->
``` http
GET https://graph.microsoft.com/beta/me/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions
```
