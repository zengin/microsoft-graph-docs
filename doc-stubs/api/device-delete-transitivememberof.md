...
-->
``` http
DELETE /devices/{devicesId}/transitiveMemberOf
```
...
<!-- {
  "blockType": "request",
  "name": "delete_transitivememberof_from_device"
}
-->
``` http
DELETE https://graph.microsoft.com/beta/devices/{devicesId}/transitiveMemberOf
```
