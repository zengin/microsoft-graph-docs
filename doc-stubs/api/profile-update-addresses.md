...
description: "Update the properties of an addresses object."
...
Update the properties of an addresses object.
...
-->
``` http
PATCH /users/{usersId}/profile/addresses
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/profile/addresses
