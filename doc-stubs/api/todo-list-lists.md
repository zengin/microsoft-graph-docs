---
title: "List lists"
description: "Get the TaskLists from the lists navigation property."
...
Get the TaskLists from the lists navigation property.
...
<!-- {
  "blockType": "response",
  "truncated": true,
  "@odata.type": "Collection(microsoft.graph.TaskList)"
}
-->
``` http
HTTP/1.1 200 OK
