...
-->
``` http
GET /identityProtection/riskyUsers/{riskyUserId}/history/{riskyUserHistoryItemId}
GET /identityProtection/riskyUsers/{riskyUserId}/history/{riskyUserHistoryItemId}/history/{riskyUserHistoryItemId}
```
...
-->
``` http
GET https://graph.microsoft.com/v1.0/identityProtection/riskyUsers/{riskyUserId}/history/{riskyUserHistoryItemId}
```
