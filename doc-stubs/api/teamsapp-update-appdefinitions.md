...
-->
``` http
PATCH /users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/teamwork/installedApps/{teamsAppInstallationId}/teamsApp/appDefinitions
...
{
  "@odata.type": "#microsoft.graph.teamsAppDefinition",
  "id": "e56e46a5-46a5-e56e-a546-6ee5a5466ee5",
  "teamsAppId": "String",
  "azureADAppId": "String",
  "displayName": "String",
  "version": "String",
