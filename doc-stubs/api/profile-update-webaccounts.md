---
title: "Update webAccounts"
description: "Update the properties of a webAccounts object."
...
Update the properties of a webAccounts object.
...
-->
``` http
PATCH /users/{usersId}/profile/webAccounts
```
...
<!-- {
  "blockType": "request",
  "name": "update_webaccounts"
}
-->
``` http
PATCH https://graph.microsoft.com/beta/users/{usersId}/profile/webAccounts
...
{
  "@odata.type": "#microsoft.graph.webAccount",
  "id": "8f9f15ac-15ac-8f9f-ac15-9f8fac159f8f",
  "allowedAudiences": "String",
  "inference": {
    "@odata.type": "microsoft.graph.inferenceData"
  },
