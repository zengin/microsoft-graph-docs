...
|[List policies](../api/application-list-policies.md)|[directoryObject](../resources/directoryobject.md) collection|Get the directoryObjects from the policies navigation property.|
