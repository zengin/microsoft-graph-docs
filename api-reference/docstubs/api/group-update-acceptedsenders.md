...
-->
``` http
PATCH ** Collection URI for microsoft.graph.directoryObject not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.directoryObject not found
...
{
  "@odata.type": "#microsoft.graph.directoryObject",
  "id": "89006616-6616-8900-1666-008916660089",
  "deletedDateTime": "String (timestamp)"
}
```
