...
-->
``` http
POST /users/{usersId}/messages/{messageId}/event/calendar/calendarView
```
...
-->
``` http
POST https://graph.microsoft.com/beta/users/{usersId}/messages/{messageId}/event/calendar/calendarView
...
{
  "@odata.type": "#microsoft.graph.event",
  "id": "05352fd4-2fd4-0535-d42f-3505d42f3505",
