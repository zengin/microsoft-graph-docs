...
-->
``` http
POST ** Collection URI for microsoft.graph.appRoleAssignment not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.appRoleAssignment not found
...
{
  "@odata.type": "#microsoft.graph.appRoleAssignment",
  "id": "adea8b25-8b25-adea-258b-eaad258beaad",
  "appRoleId": "Guid",
  "creationTimestamp": "String (timestamp)",
  "principalDisplayName": "String",
  "principalId": "Guid",
