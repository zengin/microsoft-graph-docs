...
-->
``` http
PATCH ** Collection URI for microsoft.graph.directorySetting not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.directorySetting not found
