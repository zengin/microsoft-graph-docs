---
title: "List request"
description: "Get the requests from the request navigation property."
...
Get the requests from the request navigation property.
...
-->
``` http
GET https://graph.microsoft.com/beta/users/{usersId}/approvals/{approvalId}/request
```
