...
-->
``` http
GET ** Collection URI for microsoft.graph.appRoleAssignment not found
```
...
-->
``` http
GET https://graph.microsoft.com/beta** Collection URI for microsoft.graph.appRoleAssignment not found
```
