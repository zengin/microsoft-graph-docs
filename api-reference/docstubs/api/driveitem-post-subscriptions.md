...
-->
``` http
POST ** Collection URI for microsoft.graph.subscription not found
```
...
-->
``` http
POST https://graph.microsoft.com/beta** Collection URI for microsoft.graph.subscription not found
