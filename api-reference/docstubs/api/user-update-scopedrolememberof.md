...
-->
``` http
PATCH ** Collection URI for microsoft.graph.scopedRoleMembership not found
```
...
-->
``` http
PATCH https://graph.microsoft.com/beta** Collection URI for microsoft.graph.scopedRoleMembership not found
...
{
  "@odata.type": "#microsoft.graph.scopedRoleMembership",
  "id": "2ca7dff1-dff1-2ca7-f1df-a72cf1dfa72c",
  "roleId": "String",
  "administrativeUnitId": "String",
  "roleMemberInfo": {
    "@odata.type": "microsoft.graph.identity"
