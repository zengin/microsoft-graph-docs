...
| **Change type** | **Version**   | **Description**                          |
| :-------------- | :------------ | :--------------------------------------- |
| Addition        | v1.0        | Promoted the following APIs to v1.0: [riskDetection](/graph/api/resources/riskdetection?view=graph-rest-1.0) and [riskyUsers](/graph/api/resources/riskyuser?view=graph-rest-1.0). |
